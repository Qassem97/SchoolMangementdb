...
using SchoolMangementdb.Models.Repository;
using SchoolMangementdb.Models.Services;
using SchoolMangementdb.Repository;
using SchoolMangementdb.Services;

namespace SchoolMangementdb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SchoolContextdb>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddScoped<ICourseAssignmnet, CourseAssignmentRepo>();
